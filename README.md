...
Dedicated, mathematically rigorous reference documents detailing foundational algorithms, signal processing transforms, neural operators, variational solvers, and geometric mechanics:
- **Signal Processing & Active Metrology**: [[techniques/fourier-domain-adaptation|Fourier Domain Adaptation (FDA)]], [[techniques/gradient-reversal-and-dann|Gradient Reversal Layers & DANN]], [[techniques/phase-shifting-profilometry-structured-light|Phase-Shifting Profilometry (PSP)]], [[techniques/sim2real-domain-randomization-and-dynamics|Sim2Real Domain Randomization]], [[techniques/masked-autoencoders-and-vision-pretraining|Masked Autoencoders (MAE)]], [[techniques/extended-kalman-filter-nonlinear-estimation|Extended Kalman Filter (EKF)]], [[techniques/unscented-kalman-filter-and-sigma-points|Unscented Kalman Filter (UKF)]]
- **Spatial, Geometric & Neural Operators**: [[techniques/deformable-convolutions|Deformable Convolutions (DCNv1–DCNv4)]], [[techniques/hypergraph-computation|Hypergraph Neural Computation]], [[techniques/lift-splat-shoot-bev-pooling|Lift-Splat-Shoot (LSS & BEV Pooling)]], [[techniques/3d-gaussian-splatting-rasterization|3D Gaussian Splatting Rasterization]], [[techniques/lie-algebra-se3-pose-tracking|Lie Algebra se(3) Pose Tracking]], [[techniques/all-pairs-correlation-pyramids|All-Pairs Correlation Pyramids (RAFT)]], [[techniques/variational-optical-flow-tv-l1|Variational Optical Flow (TV-L1)]], [[techniques/multiresolution-hash-encodings-and-sparse-voxels|Multiresolution Spatial Hash Encodings]], [[techniques/orthogonal-procrustes-and-umeyama-sim3|Orthogonal Procrustes & Umeyama Alignment]], [[techniques/point-cloud-pillar-feature-encoding|Point Cloud Pillar Feature Encoding]], [[techniques/bundle-adjustment-and-schur-complement|Bundle Adjustment & Schur Complement]], [[techniques/epipolar-geometry-essential-matrix|Epipolar Geometry & Essential Matrix]], [[techniques/perspective-n-point-epnp-pose-estimation|Perspective-n-Point (EPnP)]], [[techniques/implicit-neural-representations-fourier-features|Implicit Neural Representations (INR)]], [[techniques/sparse-submanifold-convolutions-spconv|Sparse Submanifold Convolutions (SpConv)]], [[techniques/iterative-closest-point-and-generalized-icp|Iterative Closest Point (ICP / G-ICP)]], [[techniques/furthest-point-sampling-and-pointnet-set-abstraction|PointNet++ Set Abstraction (FPS)]], [[techniques/photometric-bundle-adjustment-and-direct-slam|Photometric Bundle Adjustment]], [[techniques/marching-cubes-and-signed-distance-functions|Marching Cubes & SDF]], [[techniques/graph-convolutional-networks-message-passing|Graph Convolutional Networks (GCN)]], [[techniques/direct-linear-transform-and-homography|Direct Linear Transform (DLT)]], [[techniques/ransac-and-robust-model-estimation|RANSAC & Robust Estimation (MAGSAC++)]], [[techniques/poisson-surface-reconstruction-screened|Poisson Surface Reconstruction]], [[techniques/steerable-convolutions-and-so3-equivariance|Steerable Convolutions & SO(3) Equivariance]]
- **Set Prediction, Losses & Safe Control**: [[techniques/bipartite-matching-and-hungarian-assigner|Bipartite Matching & Hungarian Assigner]], [[techniques/distribution-focal-loss-vs-direct-regression|Distribution Focal Loss (DFL) vs. Direct Metric Regression]], [[techniques/contrastive-learning-infonce-vs-siglip|Contrastive SigLIP vs. InfoNCE]], [[techniques/control-barrier-functions-safe-control|Control Barrier Functions (CBF-QP)]], [[techniques/error-state-kalman-filter-eskf-vio|Error-State Kalman Filter (ESKF)]], [[techniques/bounding-box-losses-giou-ciou-nwd|Bounding Box Losses (CIoU / NWD)]], [[techniques/focal-loss-and-class-imbalance|Focal Loss & Class Imbalance]], [[techniques/feature-pyramid-networks-and-path-aggregation|FPN & Path Aggregation (BiFPN)]], [[techniques/two-stage-association-bytetrack|Two-Stage Association (ByteTrack)]], [[techniques/spatial-pyramid-pooling-spp-sppf-aspp|Spatial Pyramid Pooling (SPPF / ASPP)]], [[techniques/roialign-and-exact-bilinear-sampling|RoIAlign & Bilinear Sampling]], [[techniques/non-maximum-suppression-greedy-soft-matrix-nms|Non-Maximum Suppression (NMS)]], [[techniques/vision-language-contrastive-alignment-clip|Vision-Language Contrastive (CLIP)]], [[techniques/cartesian-impedance-and-admittance-control|Cartesian Impedance Control]], [[techniques/model-predictive-control-and-trajectory-optimization|Model Predictive Control (MPC)]]
- **Attention, State-Space & Continuous Dynamics**: [[techniques/flash-attention-and-online-softmax|FlashAttention & Online Softmax]], [[techniques/visual-state-space-mamba|Visual State-Space Models (VMamba / SS2D)]], [[techniques/continuous-flow-matching|Continuous Flow Matching (CFM)]], [[techniques/action-chunking-cvae|Action Chunking with C-VAE (ACT)]], [[techniques/multi-scale-deformable-attention|Multi-Scale Deformable Attention (MS-DeformAttn)]], [[techniques/shifted-window-attention-swin|Shifted Window Attention (Swin)]], [[techniques/rotary-positional-embeddings-rope-and-mrope|Rotary Positional Embeddings (RoPE / M-RoPE)]], [[techniques/denoising-diffusion-ddpm-and-ddim|Denoising Diffusion Models (DDPM / DDIM)]], [[techniques/multi-head-scaled-dot-product-attention|Multi-Head Self-Attention (MHA)]], [[techniques/cross-attention-and-query-based-decoding|Cross-Attention & Query Decoding]], [[techniques/joint-embedding-predictive-architecture-jepa|Joint-Embedding Predictive Architecture (JEPA)]]
- **Hardware Acceleration & Precision**: [[techniques/structural-reparameterization|Structural Reparameterization (RepConv)]], [[techniques/post-training-quantization-and-outlier-smoothing|PTQ & Outlier Smoothing (SmoothQuant)]], [[techniques/mixed-precision-training-and-loss-scaling|Mixed-Precision Training (AMP)]], [[techniques/knowledge-distillation-and-logits-matching|Knowledge Distillation (KD)]], [[techniques/structured-weight-pruning-and-2-4-sparsity|Structured Weight Pruning (2:4 Sparsity)]], [[techniques/zero-copy-ipc-and-posix-shared-memory|Zero-Copy IPC & POSIX Shared Memory]]
- **Complete Visual Index & Flow Graph**: [[techniques/00-techniques-moc|Techniques & Mechanics MOC]]
---
...
- **[[architectures/hardware-and-acceleration-runtimes/onnxruntime-runtime|ONNX Runtime: Cross-Platform Execution Provider Architecture & Zero-Copy IOBinding]]**: High-Throughput Inference Engine & Runtime (MIT).
...
- **[[architectures/hardware-and-acceleration-runtimes/vulkan-sc-runtime|Vulkan SC 2.0: Deterministic Safety-Critical Compute & Static Offline Pipeline Architecture]]**: Safety-Critical Hardware Compute Runtime (Apache-2.0 / Khronos Group).
