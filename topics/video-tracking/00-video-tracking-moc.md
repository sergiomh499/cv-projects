...
1. **Real-Time Multiple Object Tracking (MOT)**: Tracking-by-detection pairing high-frame-rate 2D detectors with lightweight CPU Kalman filters and appearance ReID matching ([[architectures/visual-tracking-and-flow/bytetrack|BoT-SORT & ByteTrack]]).
...
| :--- | :--- | :--- | :---: | :---: |
| **BoT-SORT & ByteTrack** | Bounding Box MOT | Global Motion Compensation (GMC) + Two-stage low-score association | **MIT** | [[architectures/visual-tracking-and-flow/bytetrack|BoT-SORT & ByteTrack]] |
