...
| **BoT-SORT & ByteTrack Deep-Dive** | `Architecture Vault` | Global Motion Compensation (GMC) + two-stage low-score Hungarian association (MIT) | [Open BoT-SORT/ByteTrack](../../architectures/real-time-unified/botsort-and-bytetrack.md) <br> `[[architectures/real-time-unified/botsort-and-bytetrack|botsort-and-bytetrack]]` |
| **CoTracker & CoTracker3 Deep-Dive** | `Architecture Vault` | Spatial-temporal cross-point attention tracking 70k points with occlusion flags (Apache-2.0) | [Open CoTracker](../../architectures/transformer-detectors/cotracker.md) <br> `[[architectures/transformer-detectors/cotracker|cotracker]]` |
| **SAM 2 Video Engine Deep-Dive** | `Architecture Vault` | Streaming spatial-temporal memory bank with 44 FPS promptable video mask propagation | [Open SAM 2](../../architectures/foundation-models/sam-2.md) <br> `[[architectures/foundation-models/sam-2|sam-2]]` |
