...
| **BoT-SORT & ByteTrack Deep-Dive** | `Architecture Vault` | Global Motion Compensation (GMC) + two-stage low-score Hungarian association (MIT) | [Open BoT-SORT/ByteTrack](../../architectures/visual-tracking-and-flow/botsort-and-bytetrack.md) <br> `[[architectures/visual-tracking-and-flow/botsort-and-bytetrack|botsort-and-bytetrack]]` |
