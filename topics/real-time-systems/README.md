...
| **Iceoryx2 & Zenoh Deep-Dive** | `Architecture Vault` | Lock-free shared memory pointer passing with sub-microsecond transport latency | [Open Iceoryx2/Zenoh](../../architectures/hardware-and-acceleration-runtimes/iceoryx2-and-zenoh.md) <br> `[[architectures/hardware-and-acceleration-runtimes/iceoryx2-and-zenoh|iceoryx2-and-zenoh]]` |
