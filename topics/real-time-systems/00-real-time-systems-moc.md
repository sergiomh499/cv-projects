...
> **Navigation**: [[README|🏠 Central Knowledge Hub]] / **Real-Time Systems
tags:
  - moc
  - systems-engineering
  - real-time
...
- Zero-copy shared memory IPC ([[architectures/hardware-and-acceleration-runtimes/iceoryx2-ipc|Iceoryx2 & Zenoh]]) delivering sub-microsecond point cloud and video frame transfers.
...
| :--- | :--- | :--- | :---: | :---: |
| **Eclipse Iceoryx2** | Lock-Free Shared Memory IPC | Pure Rust/C++ pointer-passing architecture delivering sub-microsecond latency ($<1\mu\text{s}$) | **Apache-2.0 / MIT** | [[architectures/hardware-and-acceleration-runtimes/iceoryx2-ipc|Iceoryx2 & Zenoh Deep-Dive]] |
| **Eclipse Zenoh** | Zero-Overhead Pub/Sub | Replaces heavy DDS discovery with 5-byte wire protocol for robotics | **Apache-2.0** | [[architectures/hardware-and-acceleration-runtimes/iceoryx2-ipc|Iceoryx2 & Zenoh Deep-Dive]] |
...
## 🧭 Navigation & Knowledge Graph
- **Historical Lineage & Evolution**: [[topics/real-time-systems/01-historical-evolution-and-paradigms|01 Historical Evolution And Paradigms]]
- **Production Implementation Playbook**: [[topics/real-time-systems/02-production-pipeline-and-workarounds|02 Production Pipeline And Workarounds]]
- **Modern Architecture & Open Problems**: [[topics/real-time-systems/03-preemption-and-open-problems|03 Preemption And Open Problems]]
- **Classical, Geometric & Hybrid Baselines**: [[topics/real-time-systems/04-classical-and-hybrid-methods|04 Classical And Hybrid Methods]]
...
WHERE contains(file.folder, "topics/real-time-systems")
SORT file.name ASC
```
