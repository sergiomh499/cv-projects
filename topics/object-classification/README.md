...
| **DINOv2 & DINOv3 Deep-Dive** | `Architecture Vault` | Multi-crop student-teacher self-distillation, iBOT masked modeling (Apache-2.0) | [Open DINOv2/v3](../../architectures/vision-foundation-models/dinov2-and-dinov3.md) <br> `[[architectures/vision-foundation-models/dinov2-and-dinov3|dinov2-and-dinov3]]` |
