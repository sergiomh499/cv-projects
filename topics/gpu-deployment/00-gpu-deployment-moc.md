...
> **Navigation**: [[README|🏠 Central Knowledge Hub]] / **GPU Deployment
tags:
  - moc
  - hardware-deployment
  - gpu
...
## 🧭 Navigation & Knowledge Graph
- **Historical Lineage & Evolution**: [[topics/gpu-deployment/01-historical-evolution-and-paradigms|01 Historical Evolution And Paradigms]]
- **Production Implementation Playbook**: [[topics/gpu-deployment/02-production-pipeline-and-workarounds|02 Production Pipeline And Workarounds]]
- **Modern Architecture & Open Problems**: [[topics/gpu-deployment/03-compilers-and-open-problems|03 Compilers And Open Problems]]
- **Classical, Geometric & Hybrid Baselines**: [[topics/gpu-deployment/04-classical-and-hybrid-methods|04 Classical And Hybrid Methods]]
...
WHERE contains(file.folder, "topics/gpu-deployment")
SORT file.name ASC
```
