...
The field has transitioned from per-object dense keypoint predictors (PVNet, DenseFusion) to zero-shot foundation models driven by 3D CAD meshes ([[architectures/real-time-unified/foundationpose-and-megapose|FoundationPose & MegaPose]]).
